...
│
├── etl/
│   ├── phase1_explore.py             ← Data exploration
│   ├── phase2_clean.py               ← Data cleaning
│   └── phase3_spark_transform.py     ← PySpark transformations
│
├── warehouse/
│   ├── phase4_warehouse.py           ← Star schema + SQLite loader
│   └── supply_chain.db               ← SQLite database (generated)
│
├── kpis/
│   ├── phase5_kpis.py                ← KPI computation via SQL
...
```bash
git clone https://github.com/your-username/supply-chain-kpi-monitor.git
cd supply-chain-kpi-monitor
```
...
```bash
python etl/phase3_spark_transform.py
```
...
```bash
python warehouse/phase4_warehouse.py
```
